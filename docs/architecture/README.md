...
The legacy Drizzle schema remains a central table registry. New bounded contexts can own a separate schema module and merge it in `lib/db/client.ts`; artifact tables follow that pattern. Domain behavior does not live in schema files.
