...
- Streaming research copilot with saved question history, source filters, claim checks, and inline citations
...
Company, theme, evidence-company, saved-memo, and copilot-session selections have durable URLs, so an analyst can reload or share a research view without losing its primary context.
